        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <div class="row">
                        <h5 style="margin:0 0 10px 15px;"><b>预约房间</b>
                        </h5>
                    </div>
                    <div class="ibox-content">
                        <s:form id="w-create-manage-form" action="reserve_add.action" cssClass="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-11">
                                    <input id="hours" name="hours" type="text" placeholder="时长"
                                           class="form-control">
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
