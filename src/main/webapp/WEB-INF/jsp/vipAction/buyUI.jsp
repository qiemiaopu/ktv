        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <div class="row">
                        <h5 style="margin:0 0 10px 15px;"><b>售卡</b>
                        </h5>
                    </div>
                    <div class="ibox-content">
                        <s:form id="w-create-manage-form" action="vip_buy.action" cssClass="form-horizontal">
                            <s:hidden name="id"></s:hidden>
                            <div class="form-group">
                                <label class="col-lg-1 control-label">卡号</label>
                                <div class="col-lg-11">
                                    <s:textfield name="number" cssClass="form-control" disabled="true"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-11">
                                    <s:textfield name="owner" cssClass="form-control"/>
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            <div class="form-group">
