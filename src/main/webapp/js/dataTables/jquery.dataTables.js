...
( /** @lends <global> */ function(window, document, undefined) {
	...
	( /** @lends <global> */ function($) {
			...
			for (i = 0, ien = columns.length; i < ien; i++) {
				...
				if (oSettings.oFeatures.bSort) {
					...
					if (column.bSortable !== false) {
						cell.attr('tabindex', oSettings.iTabIndex)
		...
		DataTable.defaults = {
			 ...
			 * the page number, so if you have 10 每页显示条数 and want to start on
			...
			"oLanguage": {
				 ...
				 *    } );
				 */
				"sInfo": "显示 _START_ 至  _END_ 项结果, &nbsp&nbsp&nbsp&nbsp 共 _TOTAL_ 项",
				 ...
				 *    } );
				 */
				"sInfoEmpty": "显示 0 至 0 项结果, &nbsp&nbsp&nbsp&nbsp 共 0 项<br> ",
		...
		$.extend(_ext.type.order, {
			...
			"string-pre": function(a) {
				...
				return _empty(a) ?
					'' : typeof a === 'string' ? a.toLowerCase() : !a.toString ?
					'' : a.toString();
			},
			...
			header: {
				...
				jqueryui: function(settings, cell, column, classes) {
					...
					$(settings.nTable).on('order.dt.DT', function(e, ctx, sorting, columns) {
						...
						cell.removeClass(classes.sSortAsc + " " + classes.sSortDesc)
							.addClass(columns[colIdx] == 'asc' ? classes.sSortAsc : columns[colIdx] == 'desc' ? classes.sSortDesc : column.sSortingClass);
